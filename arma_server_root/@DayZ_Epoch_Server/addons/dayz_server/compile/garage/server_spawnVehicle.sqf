...
// This file original source: https://github.com/oiad/virtualGarage/blob/master/dayz_server/compile/garage/server_spawnVehicle.sqf
// ---------------------------------------------------------------------------
...
// ===========================================================================
private ["_worldSpace","_player","_id","_return","_class","_characterID",
"_inventory","_hitpoints","_fuel","_damage","_dir","_location","_uid",
"_key","_colour","_colour2","_result"];
...
//Send request
_key = format [
   "CHILD:308:%1:%2:%3:%4:%5:%6:%7:%8:%9:"
  ,dayZ_instance,_class,_damage,_characterID,_worldSpace,_inventory,_hitpoints,_fuel,_uid
];
